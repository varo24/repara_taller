...
import {
  Search, Trash2, Filter, Pencil, ChevronDown, User, Smartphone,
  FilePlus, FileEdit, Printer, Tag,
} from 'lucide-react';
...
interface RepairListProps {
  ...
  onPrintLabel: (repair: RepairItem) => void;
                ...
                <tr key={repair.id} className="hover:bg-blue-50/20 transition-colors group">
                  ...
                  <td className="px-4 py-8">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 bg-slate-100 rounded-xl flex items-center justify-center text-slate-400 group-hover:bg-white transition-colors">
                        <User size={16} />
                      </div>
                      <div>
                  ...
                  <td className="px-4 py-8">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 bg-blue-50 text-blue-500 rounded-xl flex items-center justify-center group-hover:bg-white transition-colors">
                        <Smartphone size={16} />
                      </div>
                      <div>
                  ...
                  <td className="px-10 py-8 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button onClick={() => onPrintLabel(repair)} title="Etiqueta Térmica" className="p-3 bg-white text-slate-400 rounded-xl hover:bg-amber-500 hover:text-white border border-slate-100 transition-all"><Tag size={16} /></button>
                      <button onClick={() => onPrintReceipt(repair)} title="Resguardo A4" className="p-3 bg-white text-slate-400 rounded-xl hover:bg-slate-900 hover:text-white border border-slate-100 transition-all"><Printer size={16} /></button>
